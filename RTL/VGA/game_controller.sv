...
assign collision = (drawing_request_boarders && drawing_request_smiley) || (drawing_request_smiley && drawing_request_box) || ( drawing_request_smiley && drawing_request_hart ); // any collision
